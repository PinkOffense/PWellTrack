export default {
  ...
  profile: {
    ...
    deleteWarning: 'Esta acao e permanente. Todos os seus dados incluindo animais, registos de alimentacao, medicacao e eventos serao permanentemente eliminados.',
